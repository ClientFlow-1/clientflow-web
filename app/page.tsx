...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  @media (max-width:768px) {
    ...
    .lp-pricing-grid { display:flex !important; overflow-x:scroll; scroll-snap-type:x mandatory; scrollbar-width:none; -webkit-overflow-scrolling:touch; padding:8px 0 20px; column-gap:0 !important; align-items:stretch !important; }
